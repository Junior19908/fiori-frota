...
title Frota - Dev (Auto Update + Auto Push)

REM Vai para a pasta do script (raiz do projeto)
cd /d "%~dp0"

echo ==========================================
echo [1/4] Atualizando repositório (DEV)...
echo ==========================================
where git >nul 2>&1 || (
...
REM Verifica usuario/e-mail Git configurados (necessario para commit/push)
set "GIT_USER_NAME="
set "GIT_USER_EMAIL="
...
REM ==========================================
REM [2/4] Detectar e enviar alteracoes locais (DEV)
REM ==========================================
set "CHANGES="
...
if defined CHANGES (
  ...
  REM Respeita o .gitignore (veiculos.json etc. ficam so locais)
  git add .
